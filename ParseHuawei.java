...
commands to execute 
cd /vava 
javac ParseHuawei.java 
java ParseHuawei 0
*/
//package Huawei;

//CREATE OR REPLACE AND RESOLVE JAVA SOURCE NAMED "ParseHuawei" AS
...
class ParseHuawei{
    ...
    public static void readText(String file_name1){
        ...
        try {
            ...
            FileInputStream fis = new FileInputStream("D:\\www\\rmfeatures\\Huawei sample CDRs\\Huawei sample CDRs\\Huawei sample CDRs\\java\\FLHE2018040311464300252754.dat");
            DataInputStream dis = new DataInputStream(fis);
        
            FileWriter outFile = new FileWriter("D:\\www\\rmfeatures\\Huawei sample CDRs\\Huawei sample CDRs\\Huawei sample CDRs\\java\\FLHE2018040311464300252754.csv");
            PrintWriter out = new PrintWriter(outFile);
            
            FileWriter outFile1 = new FileWriter("D:\\www\\rmfeatures\\Huawei sample CDRs\\Huawei sample CDRs\\Huawei sample CDRs\\java\\FLHE2018040311464300252754_parse2.csv");
